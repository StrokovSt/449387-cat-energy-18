 ...
 */
(function (window) { /*jshint eqnull:true */
...
(function (window, document, undefined) { // Enable strict mode
    ...
    var picturefill = function (opt) {
        ...
        elements = options.elements || pf.qsa(
    ...
    function getAllSourceElements(picture, candidates) {
        ...
        for (i = 0, len = sources.length; i < len; i++) {
            ...
            if (srcset) {
                candidates.push({srcset: srcset, media: source.getAttribute("media"), type: source.getAttribute("type"), sizes: source.getAttribute("sizes")});
            }
        }
    }
    /**
    ...
    function parseSrcset(input, set) {
		...
		*/
        function tokenize() { // 8.1. Descriptor tokeniser: Skip whitespace
            ...
            state = "in descriptor";
            while (true) { // 8.4. Let c be the character at position.
                c = input.charAt(pos);
            ...
            while (true) {
                ...
                if (chrctr === "") { // ( End of string reached.)
                    ...
                    if ((str.charAt(pos - 1) && isSpace(str.charAt(pos - 1))) || ! component) {
                        ...
                        pos += 1;
                        continue;
                    } else { // (Replace any space character with a plain space for legibility.)
                        chrctr = " ";
                    }
                } else if (chrctr === "(") {
                    parenDepth += 1;
    ...
    if (pf.supPicture) {
        picturefill = noop;
        pf.fillImg = noop;
    } else { // Set up picture polyfill by polling the document
        (function () {
            var isDomReady;
            var regReady = window.attachEvent
                ? /d$|^c/
                : /d$|^c|^i/;
            var run = function () {
